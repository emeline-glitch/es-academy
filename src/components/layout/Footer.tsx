        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex items-center gap-3 mt-3">
              <a
                ...
                className="inline-flex items-center justify-center w-10 h-10 -m-2 text-white/40 hover:text-white transition-colors"
              >
          ...
          <div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <Link href="/simulateurs" className="text-sm text-white/40 hover:text-white transition-colors">Simulateurs</Link>
