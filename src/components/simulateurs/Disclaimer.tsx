  ...
  return (
    <div className="mt-8 bg-gray-50 rounded-xl p-5 border border-gray-200">
      ...
      <p className="text-xs text-gray-500 leading-relaxed">
        Ce simulateur fournit une estimation indicative basée sur les données que vous renseignez.
        ...
        les établissements bancaires ou les notaires. Pour un calcul précis adapté à votre situation,
        consultez un professionnel (courtier, notaire, expert-comptable).
      </p>
