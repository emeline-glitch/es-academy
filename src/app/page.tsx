          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex items-center gap-3">
                ...
                <a href="https://fr.linkedin.com/in/emeline-siron" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-es-green/10 flex items-center justify-center hover:bg-es-green/20 transition-colors">
