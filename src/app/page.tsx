          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex items-center gap-3">
                <a href="https://www.instagram.com/emelinesiron/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="w-9 h-9 rounded-full bg-es-green/10 flex items-center justify-center text-es-green hover:bg-es-green hover:text-white transition-all">
                ...
                <a href="https://fr.linkedin.com/in/emeline-siron" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="w-9 h-9 rounded-full bg-es-green/10 flex items-center justify-center text-es-green hover:bg-es-green hover:text-white transition-all">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
                </a>
                <a href="https://www.youtube.com/@emelinesiron" target="_blank" rel="noopener noreferrer" aria-label="YouTube" className="w-9 h-9 rounded-full bg-es-green/10 flex items-center justify-center text-es-green hover:bg-es-green hover:text-white transition-all">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-5xl mx-auto px-6">
          <ScrollReveal>
            <div className="text-center mb-12">
              <h2 className="font-serif text-3xl sm:text-4xl font-bold text-es-text">
                Mon podcast sur l&apos;investissement
              </h2>
            </div>

            <div className="flex flex-col md:flex-row items-center justify-center gap-8 mb-10">
              {/* Visuel podcast : cadre vert avec logo OTB centre, plus
                  cohérent que l'ancienne photo bébé + micro. */}
              <div className="shrink-0 w-40 h-40 sm:w-48 sm:h-48 rounded-2xl overflow-hidden shadow-md bg-es-green-dark flex items-center justify-center p-6 relative">
                {/* Pattern dots subtil */}
              ...
              <div className="text-center md:text-left max-w-xl">
                <p className="text-xs uppercase tracking-widest text-es-terracotta font-medium mb-3">
                  Out of the Box · Saison 1
                </p>
                <p className="text-es-text text-lg leading-relaxed">
